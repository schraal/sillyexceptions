 ...
 * @version $Id: ParserTest.java,v 1.1 2004/08/26 07:25:03 hippe Exp $
 */
public class ParserTest extends TestCase {
	...
	public void testFirstFile() throws Exception {
		...
		new CvsFileBlockParser(new LookaheadReader(reader), mock, true).parse();
		mock.verify();
	}
	...
	private void parseOneFile(String name) throws Exception {
		Reader reader = new InputStreamReader(getClass().getResourceAsStream(name));
		new CvsFileBlockParser(new LookaheadReader(reader), mock, false).parse();
	}
