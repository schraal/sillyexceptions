 ...
 * @version $Id: WebRepositoryIntegrationTest.java,v 1.1 2004/08/26 07:25:04 hippe Exp $
 */
public class WebRepositoryIntegrationTest extends TestCase {
	...
	public void testViewcvsForgivingBaseURL() {
		...
		file.addChangeRevision("1.1", null, date, null, 0, 0, 0);
	...
	public void testViewcvsDiff() {
		CvsFile file = new CvsFile("file", root);
		CvsRevision rev1 = file.addChangeRevision("1.1", null, date, null, 0, 0, 0);
		CvsRevision rev2 = file.addChangeRevision("1.2", null, date, null, 0, 0, 0);
		assertEquals(
