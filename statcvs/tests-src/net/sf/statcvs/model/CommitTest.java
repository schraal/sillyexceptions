 ...
 * @version $Id: CommitTest.java,v 1.1 2004/08/26 07:25:04 hippe Exp $
 */
public class CommitTest extends TestCase {
	...
	private CvsRevision createRevision(CvsFile file, String revision, long time, Author author, String message) {
		return new CvsRevision(file, revision, CvsRevision.TYPE_CHANGE, author, new Date(time), message, 0, 0, 0);
	}
}
