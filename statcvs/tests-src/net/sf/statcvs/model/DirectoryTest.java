 ...
 * @version $Id: DirectoryTest.java,v 1.1 2004/08/26 07:25:04 hippe Exp $
 */
public class DirectoryTest extends TestCase {
	...
	public void testRevisions() {
		...
		CvsRevision rev11 = file1.addInitialRevision("1.1", author, date1, null, 0);
		CvsRevision rev12 = file1.addChangeRevision("1.2", author, date3, null, 0, 0, 0);
		CvsFile file2 = new CvsFile("src/net/sf/statcvs/README", rootSrcNetSfStatcvs);
		CvsRevision rev21 = file2.addInitialRevision("2.1", author, date2, null, 0);
		CvsFile file3 = new CvsFile("fileInRoot", root);
		file3.addInitialRevision("3.1", author, date4, null, 0);
	...
	public void testNonEmptyRepository() {
		...
		file1.addInitialRevision("1.1", author, date1, null, 100);
		assertTrue(!root.isEmpty());
	...
	public void testEmptyRepositoryWithDeletedFile() {
		CvsFile file1 = new CvsFile("src/README", rootSrc);
		file1.addInitialRevision("1.1", author, date1, null, 100);
		file1.addDeletionRevision("1.2", author, date2, null, 100);
		assertTrue(root.isEmpty());
		assertTrue(rootSrc.isEmpty());
		assertTrue(rootSrcNet.isEmpty());
	...
	public void testNonEmptyRepositoryWithDeletedFile() {
		...
		file2.addInitialRevision("1.1", author, date1, null, 100);
		CvsFile file3 = new CvsFile("fileInRoot", root);
		file3.addInitialRevision("1.1", author, date1, null, 100);
		CvsFile file4 = new CvsFile("src/deleted", rootSrc);
		file4.addInitialRevision("1.1", author, date1, null, 100);
		file4.addDeletionRevision("1.2", author, date2, null, 100);
		assertTrue(!root.isEmpty());
		assertTrue(!rootSrc.isEmpty());
		assertTrue(rootSrcNet.isEmpty());
